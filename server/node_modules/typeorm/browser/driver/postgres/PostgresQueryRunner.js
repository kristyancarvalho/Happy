...
var PostgresQueryRunner = /** @class */ (function (_super) {
     ...
     */
    PostgresQueryRunner.prototype.release = function (err) {
        if (this.isReleased) {
    ...
    PostgresQueryRunner.prototype.query = function (query, parameters) {
        ...
        return new Promise(function (ok, fail) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            var databaseConnection_1, queryStartTime_1, onError_1, err_1;
            var _this = this;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 1:
                        ...
                        onError_1 = function (err) {
                            _this.release(err);
                        };
                        databaseConnection_1.once("error", onError_1);
                        databaseConnection_1.query(query, parameters, function (err, result) {
                            databaseConnection_1.removeListener("error", onError_1);
